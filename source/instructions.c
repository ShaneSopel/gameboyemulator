...
instruction instructions[0x100] =
{
    ...
    [0xC7] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, 0x00},
    ...
    [0xCF] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, 0x08},
    ...
    [0xEE] = {IN_XOR, AM_D8},
    [0xEF] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, 0x28},
    ...
    [0xF6] = {IN_OR, AM_D8},
    [0xE7] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, 0x30},
    [0xFA] = {IN_LD, AM_R_A16, RT_NONE, RT_A},
    [0xFF] = {IN_RST, AM_IMP, RT_NONE, RT_NONE, 0x38},
};
